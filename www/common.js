...
/* harmony export */ });
/* harmony import */ var _capacitor_CFERIeaU_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./capacitor-CFERIeaU.js */ 25051);
/*!
...
/* harmony export */ });
/* harmony import */ var C_Users_Marcin_Documents_Python_Beanconqueror_Beanconqueror_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 89204);
...
const createKeyboardController = /*#__PURE__*/function () {
  var _ref = (0,C_Users_Marcin_Documents_Python_Beanconqueror_Beanconqueror_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (keyboardChangeCallback) {
    ...
    const init = /*#__PURE__*/function () {
      var _ref2 = (0,C_Users_Marcin_Documents_Python_Beanconqueror_Beanconqueror_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
/* harmony export */ });
/* harmony import */ var _index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index-4DxY6_gG.js */ 19335);
/* harmony import */ var _haptic_DzAMWJuk_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./haptic-DzAMWJuk.js */ 8235);
/* harmony import */ var _index_CfgBF1SE_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index-CfgBF1SE.js */ 75860);
/*!
 * (C) Ionic http://ionicframework.com - MIT License
 */
...
/* harmony import */ var _capacitor_CFERIeaU_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./capacitor-CFERIeaU.js */ 25051);
/* harmony import */ var _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index-ZjP4CjeZ.js */ 10575);
/*!
 * (C) Ionic http://ionicframework.com - MIT License
 */
...
/* harmony export */ });
/* harmony import */ var _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index-ZjP4CjeZ.js */ 10575);
/*!
 * (C) Ionic http://ionicframework.com - MIT License
 */
...
/* harmony export */ });
/* harmony import */ var C_Users_Marcin_Documents_Python_Beanconqueror_Beanconqueror_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 89204);
/* harmony import */ var _helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers-8KSQQGQy.js */ 96721);
/* harmony import */ var _index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index-4DxY6_gG.js */ 19335);
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,C_Users_Marcin_Documents_Python_Beanconqueror_Beanconqueror_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
...
/* harmony export */ });
/* harmony import */ var _helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers-8KSQQGQy.js */ 96721);
/* harmony import */ var _dir_C53feagD_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dir-C53feagD.js */ 11008);
/* harmony import */ var _index_CfgBF1SE_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index-CfgBF1SE.js */ 75860);
/* harmony import */ var _index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index-4DxY6_gG.js */ 19335);
/* harmony import */ var _gesture_controller_BTEOs1at_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./gesture-controller-BTEOs1at.js */ 70566);
/*!
 * (C) Ionic http://ionicframework.com - MIT License
 */
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DarkModeBase: () => (/* binding */ DarkModeBase)
/* harmony export */ });
/* harmony import */ var C_Users_Marcin_Documents_Python_Beanconqueror_Beanconqueror_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 89204);
/* harmony import */ var _capacitor_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @capacitor/core */ 2391);
/* harmony import */ var _capacitor_status_bar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @capacitor/status-bar */ 42135);
/* harmony import */ var _definitions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./definitions */ 79715);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils */ 37984);
...
class DarkModeBase extends _capacitor_core__WEBPACK_IMPORTED_MODULE_1__.WebPlugin {
  constructor() {
    super(...arguments);
    this.appearance = _definitions__WEBPACK_IMPORTED_MODULE_3__.DarkModeAppearance.system;
  ...
  setNativeDarkModeListener(options, callback) {
    var _this = this;
    return (0,C_Users_Marcin_Documents_Python_Beanconqueror_Beanconqueror_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      throw _this.unimplemented('setNativeDarkModeListener is native only');
    })();
  }
  ...
  init() {
    ...
    return (0,C_Users_Marcin_Documents_Python_Beanconqueror_Beanconqueror_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* ({
      ...
      if (getComputedStyle(document.documentElement).getPropertyValue('--ion-dynamic-font')) {
        _this2.darkModeClass = 'ion-palette-dark';
      }
      if (cssClass) {
        // Remove the old class if it exists
        document.documentElement.classList.remove(_this2.darkModeClass);
        _this2.darkModeClass = cssClass;
      }
      _this2.statusBarBackgroundVariable =
      // eslint-disable-next-line @typescript-eslint/prefer-nullish-coalescing
      statusBarBackgroundVariable || kDefaultBackgroundVariable;
      if (typeof getter === 'function') {
        _this2.getter = getter;
      }
      if (typeof setter === 'function') {
        _this2.setter = setter;
      }
      if (typeof syncStatusBar === 'boolean' || syncStatusBar === 'textOnly') {
        _this2.syncStatusBar = syncStatusBar;
      }
      if (typeof statusBarStyleGetter === 'function') {
        _this2.statusBarStyleGetter = statusBarStyleGetter;
      }
      if (typeof disableTransitions === 'boolean') {
        _this2.handleTransitions = disableTransitions;
      }
      if (!_this2.registeredListener) {
        yield _this2.registerDarkModeListener();
      }
      yield _this2.update();
  ...
  configure(options) {
    var _this3 = this;
    return (0,C_Users_Marcin_Documents_Python_Beanconqueror_Beanconqueror_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return _this3.init(options);
    })();
  }
  addAppearanceListener(listener) {
    var _this4 = this;
    return (0,C_Users_Marcin_Documents_Python_Beanconqueror_Beanconqueror_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this4.appearanceListeners.add(listener);
      return Promise.resolve({
        remove: () => _this4.appearanceListeners.delete(listener)
      });
    })();
  }
  disableTransitions() {
  ...
  update(data) {
    ...
    return (0,C_Users_Marcin_Documents_Python_Beanconqueror_Beanconqueror_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const oldDarkMode = document.documentElement.classList.contains(_this5.darkModeClass);
      let darkMode;
      let appearance = _this5.appearance;
      // The appearance changed, either by the system or by the user.
      // See if there is a stored appearance.
      if (_this5.getter) {
        const getterResult = yield _this5.getter();
        if (getterResult) {
          appearance = getterResult;
        }
      }
      // If the appearance is system, use the current dark mode.
      if (appearance === _definitions__WEBPACK_IMPORTED_MODULE_3__.DarkModeAppearance.system) {
        darkMode = data ? data.dark : (yield _this5.isDarkMode()).dark;
      } else {
        // Otherwise, use the appearance to determine the dark mode.
        darkMode = appearance === _definitions__WEBPACK_IMPORTED_MODULE_3__.DarkModeAppearance.dark;
      }
      // If the dark mode changed, update the body class and status bar.
      if (darkMode !== oldDarkMode) {
        _this5.disableTransitions();
        document.documentElement.classList[darkMode ? 'add' : 'remove'](_this5.darkModeClass);
        _this5.enableTransitions();
      }
      ...
      if (_capacitor_core__WEBPACK_IMPORTED_MODULE_1__.Capacitor.isNativePlatform()) {
        yield _this5.handleStatusBar(darkMode);
      }
      // If the appearance changed, update the stored appearance.
      if (_this5.setter && _this5.appearance !== appearance) {
        yield _this5.setter(appearance);
      }
      // Notify listeners of the changes by the system.
      if (data) {
        for (const listener of _this5.appearanceListeners) {
          listener(data);
        }
      }
      _this5.appearance = appearance;
      return Promise.resolve(_this5.appearance);
    })();
  }
  getBackgroundColor() {
    ...
    if (content) {
      ...
      if ((0,_utils__WEBPACK_IMPORTED_MODULE_4__.isValidHexColor)(color)) {
        return (0,_utils__WEBPACK_IMPORTED_MODULE_4__.normalizeHexColor)(color);
      } else {
  ...
  handleStatusBar(darkMode) {
    ...
    return (0,C_Users_Marcin_Documents_Python_Beanconqueror_Beanconqueror_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      let setStatusBarStyle = _capacitor_core__WEBPACK_IMPORTED_MODULE_1__.Capacitor.getPlatform() === 'ios';
      // By default the status bar style is the same as the appearance.
      let statusBarStyle = darkMode ? _capacitor_status_bar__WEBPACK_IMPORTED_MODULE_2__.Style.Dark : _capacitor_status_bar__WEBPACK_IMPORTED_MODULE_2__.Style.Light;
      // By default we will not change the background color of the status bar.
      let color = '';
      if (_this6.syncStatusBar && _capacitor_core__WEBPACK_IMPORTED_MODULE_1__.Capacitor.getPlatform() === 'android') {
        ...
        if (_this6.syncStatusBar !== 'textOnly') {
          color = _this6.getBackgroundColor();
        }
        if (_this6.statusBarStyleGetter) {
          // If there is a style getter, use it to determine the status bar style.
          const style = yield _this6.statusBarStyleGetter(statusBarStyle, color);
          if (style) {
          ...
          // based on the color.
          statusBarStyle = (0,_utils__WEBPACK_IMPORTED_MODULE_4__.isDarkColor)(color) ? _capacitor_status_bar__WEBPACK_IMPORTED_MODULE_2__.Style.Dark : _capacitor_status_bar__WEBPACK_IMPORTED_MODULE_2__.Style.Light;
        } else if (_this6.syncStatusBar !== 'textOnly') {
      ...
      const actions = [];
      if (color) {
        actions.push(_capacitor_status_bar__WEBPACK_IMPORTED_MODULE_2__.StatusBar.setBackgroundColor({
          color
        }));
      }
      if (setStatusBarStyle) {
        actions.push(_capacitor_status_bar__WEBPACK_IMPORTED_MODULE_2__.StatusBar.setStyle({
...
const createLockController = () => {
  ...
  const lock = /*#__PURE__*/function () {
    var _ref = (0,C_Users_Marcin_Documents_Python_Beanconqueror_Beanconqueror_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const p = waitPromise;
      let resolve;
